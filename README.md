...
## 8. 한 줄 회고
* **김민준**: "크롤링을 해서 가져온 데이터를 바로 데이터베이스에 넣는 방법과 json으로 변형을 시켜서 데이터를 활용하는 방법 이렇게 두 가지를 활용해보면서 데이터들이 연결되는 방법을 배웠습니다. 다만 ERD 의 FK,PK를 설계하는 부분에서 부족함이 느껴졌던게 아쉬운 부분으로 남아서 이 부분에 학습을 좀 더 집중있게 해야겠다는 생각이 들었습니다."
